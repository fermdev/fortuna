...
export const config = {
  ...
  gmgn: {
    ...
    cooldownMinutes: gmgnValue("cooldownMinutes", "gmgnCooldownMinutes", 30),
    rateLimitCooldownMinutes: gmgnValue("rateLimitCooldownMinutes", "gmgnRateLimitCooldownMinutes", 10),
